...
public class PatientUpdate implements Parcelable {
    ...
    protected PatientUpdate(Parcel in) {
    ...
    public static final Creator<PatientUpdate> CREATOR = new Creator<PatientUpdate>() {
        @Override
        public PatientUpdate createFromParcel(Parcel in) {
            return new PatientUpdate(in);
        }

        @Override
        public PatientUpdate[] newArray(int size) {
            return new PatientUpdate[size];
        }
    };
